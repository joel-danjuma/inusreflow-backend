...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/ReminderStatusBadge.tsx
  var ReminderStatusBadge_exports = {};
  __export(ReminderStatusBadge_exports, {
  ...
  function AllStatuses() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-wrap gap-2 p-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ReminderStatusBadge, { status: "queued" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ReminderStatusBadge, { status: "sent" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ReminderStatusBadge, { status: "failed" })
    ] });
  }
  return __toCommonJS(ReminderStatusBadge_exports);
})();
