...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/InstallmentStatusBadge.tsx
  var InstallmentStatusBadge_exports = {};
  __export(InstallmentStatusBadge_exports, {
  ...
  function AllStatuses() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-wrap gap-2 p-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(InstallmentStatusBadge, { status: "due" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(InstallmentStatusBadge, { status: "overdue" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(InstallmentStatusBadge, { status: "paid" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(InstallmentStatusBadge, { status: "cancelled" })
    ] });
  }
  return __toCommonJS(InstallmentStatusBadge_exports);
})();
