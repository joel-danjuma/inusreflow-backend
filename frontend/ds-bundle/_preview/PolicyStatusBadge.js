...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/PolicyStatusBadge.tsx
  var PolicyStatusBadge_exports = {};
  __export(PolicyStatusBadge_exports, {
  ...
  function AllStatuses() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-wrap gap-2 p-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PolicyStatusBadge, { status: "active" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PolicyStatusBadge, { status: "lapsed" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(PolicyStatusBadge, { status: "cancelled" })
    ] });
  }
  return __toCommonJS(PolicyStatusBadge_exports);
})();
