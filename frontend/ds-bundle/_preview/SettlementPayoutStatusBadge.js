...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/SettlementPayoutStatusBadge.tsx
  var SettlementPayoutStatusBadge_exports = {};
  __export(SettlementPayoutStatusBadge_exports, {
  ...
  function SettlementPayoutStatusBadge({ status }) {
  ...
  function AllStatuses() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-wrap gap-2 p-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SettlementPayoutStatusBadge, { status: "pending" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SettlementPayoutStatusBadge, { status: "success" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(SettlementPayoutStatusBadge, { status: "failed" })
    ] });
  }
  return __toCommonJS(SettlementPayoutStatusBadge_exports);
})();
