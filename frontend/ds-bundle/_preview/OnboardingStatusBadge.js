...
var __dsPreview = (() => {
  ...
  // .design-sync/previews/OnboardingStatusBadge.tsx
  var OnboardingStatusBadge_exports = {};
  __export(OnboardingStatusBadge_exports, {
  ...
  function AllStatuses() {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-wrap gap-2 p-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(OnboardingStatusBadge, { status: "pending" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(OnboardingStatusBadge, { status: "approved" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(OnboardingStatusBadge, { status: "rejected" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(OnboardingStatusBadge, { status: "suspended" })
    ] });
  }
  return __toCommonJS(OnboardingStatusBadge_exports);
})();
