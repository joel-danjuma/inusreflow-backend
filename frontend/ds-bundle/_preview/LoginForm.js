...
var __dsPreview = (() => {
  ...
  function LoginForm({ next }) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("form", { onSubmit: handleSubmit, className: "space-y-5", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Button, { type: "submit", disabled: submitting, className: "w-full", children: submitting ? "Signing in…" : "Sign in" })
    ] });
  }
  ...
  function Default() {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "p-6 max-w-sm", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(LoginForm, { next: "/dashboard" }) });
  }
